...
export default function manifest(): MetadataRoute.Manifest {
  return {
    name: 'Farrukh-Books',
    short_name: 'FarrukhBooksPWA',
    description: 'Farrukh-Books is an accounting and inventory management application designed for small to medium-sized businesses.',
    start_url: '/',
    display: 'standalone',
    ...
    "screenshots": [
        {
          "src": "AppImages/screenshots/1.jpg",
          "type": "image/png",
          "sizes": "1920x1080",
          "form_factor": "wide"
        },
